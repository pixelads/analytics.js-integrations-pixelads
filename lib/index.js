...
/**
 * Expose `Pixelads` integration.
 */

var Pixelads = exports = module.exports = integration("pixelads")
  .option('apiKey', '');
...
Pixelads.prototype.initialize = function() {
  console.log("!");
  var self = this;
  this.ready();
 ...
 */
/*
Pixelads.prototype.loaded = function() {
  return true;
};
*/
...
Pixelads.prototype.page = function(page) {
...
Pixelads.prototype.identify = function(identify) {
...
Pixelads.prototype.group = function(group) {
...
Pixelads.prototype.track = function(track, options) {
  console.log("track");
  var json = track.json();
...
Pixelads.prototype.alias = function(alias) {
  var json = alias.json();
...
Pixelads.prototype.normalize = function(msg) {
...
Pixelads.prototype.send = function(path, msg, fn) {
  var url = scheme() + '//api.pixelads.com/v1' + path;
...
Pixelads.prototype.cookie = function(name, val) {
  var store = Pixelads.storage();
...
Pixelads.prototype.referrerId = function(query, ctx) {
