...
/**
 * Expose `Scrubkit` integration.
 */

var Scrubkit = exports = module.exports = integration("scrubkit")
  .option('apiKey', '');
...
Scrubkit.prototype.initialize = function() {
  console.log("!");
  var self = this;
  this.ready();
 ...
 */
/*
Scrubkit.prototype.loaded = function() {
  return true;
};
*/
...
Scrubkit.prototype.page = function(page) {
...
Scrubkit.prototype.identify = function(identify) {
...
Scrubkit.prototype.group = function(group) {
...
Scrubkit.prototype.track = function(track, options) {
  console.log("track");
  var json = track.json();
...
Scrubkit.prototype.alias = function(alias) {
  var json = alias.json();
...
Scrubkit.prototype.normalize = function(msg) {
...
Scrubkit.prototype.send = function(path, msg, fn) {
  var url = scheme() + '//api.scrubkit.com/v1' + path;
...
Scrubkit.prototype.cookie = function(name, val) {
  var store = Scrubkit.storage();
...
Scrubkit.prototype.referrerId = function(query, ctx) {
